...
public class VendedorDTO extends EmpleadoDTO{
    ...
    public VendedorDTO(String nombre, String apellidos, int DNI, String dirección, int anioAntiguo, int fono, int salario, int dniSupervisor) {
        super(nombre, apellidos, DNI, dirección, anioAntiguo, fono, salario, dniSupervisor, "Vendedor");
    }

    public VendedorDTO(boolean coche, String matricula, String marca, String modelo, int movil, String areaVenta, int porcentajeVenta, String nombre, String apellidos, int DNI, String dirección, int anioAntiguo, int fono, int salario, int dniSupervisor) {
        super(nombre, apellidos, DNI, dirección, anioAntiguo, fono, salario, dniSupervisor, "Vendedor");
        this.coche = coche;
        this.matricula = matricula;
        this.marca = marca;
